...
class ReVerbTrainRaw(object):
    def __init__(self):
        ...
        self.content = c.execute("SELECT * FROM "
                                 "( SELECT * FROM tuples WHERE rel not like '%-in.r' or not like '%-on.r' LIMIT 10000 )"
                                 " UNION "
                                 "SELECT * FROM "
                                 "( SELECT * FROM tuples WHERE rel like '%-in.r' LIMIT 10000 ) "
                                 "UNION "
                                 "SELECT * FROM "
                                 "( SELECT * FROM tuples WHERE rel like '%-on.r' LIMIT 10000 )")
        # define the pattern
