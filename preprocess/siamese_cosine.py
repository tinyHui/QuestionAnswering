...
def build_model(tparams, options):
    ...
    score1 /= normalization
    score2 /= normalization
    score3 /= normalization
    ...
    score1_p /= normalization_p
    score2_p /= normalization_p
    score3_p /= normalization_p
...
def train_lstm(
    ...
    optimizer=adadelta,  # sgd, adadelta and rmsprop available, sgd very hard to use,
    ...
    print('The code run for %d epochs, with %f sec/epochs' % (
          max_epochs, (end_time - start_time) / (1. * max_epochs)))
